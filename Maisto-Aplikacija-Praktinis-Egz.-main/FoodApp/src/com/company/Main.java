...
public class Main {
    ...
    public static void main(MysqlxDatatypes.Scalar.String[] args) {
        MysqlxDatatypes.Scalar.String loginOrReg;
        MysqlxDatatypes.Scalar.String logUsername;
        MysqlxDatatypes.Scalar.String logPassword;
        MysqlxDatatypes.Scalar.String regUsername;
        MysqlxDatatypes.Scalar.String regPassword;
    ...
    public static void adminFunc(){
        while (true) {
            ...
            Scanner scan = new Scanner(System.in);
            MysqlxDatatypes.Scalar.String chooseOpAdmin;
            MysqlxDatatypes.Scalar.String addDish;
            MysqlxDatatypes.Scalar.String descDish;
            int dishDelete;
            int dishUpdate;
            String updateDish;
